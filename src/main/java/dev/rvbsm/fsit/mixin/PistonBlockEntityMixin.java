...
public abstract class PistonBlockEntityMixin {
	...
	private static boolean canMoveEntity$isOnGround$isSeat(Entity entity) {
	...
	private static void moveEntitiesInHoneyBlock$moveEntity$moveSeat(Direction direction, Entity entity, double distance, Direction movementDirection) {
